...
public final class Commons {
    ...
    public static final int BOARD_GROUND = 290;
    ...
    public static final int CHANCE_GENERATOR = 15;

    public static final int DELAY = 17;
    public static final int PLAYER_WIDTH = 15;
    public static final int PLAYER_HEIGHT = 10;

    public static final String MESSAGE_WON = "GAME WON";
    public static final String MESSAGE_OVER = "GAME OVER";
    public static final String MESSAGE_INVASION = "INVASION!!!";
